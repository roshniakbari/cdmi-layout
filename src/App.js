        ...
        <div className="container">
          <div className="logo_header flex">
            ...
            <div className="main_menu">
              ...
              <div className="single_menu">COURSES</div>
              <div className="single_menu">ACTIVITIES</div>
              <div className="single_menu">BLOG</div>
              <div className="single_menu">KONW US</div>
              <div className="single_menu">GET IN TOUCH</div>
              <div className="single_menu">STUDENT ZONE</div>
            </div>
          </div>
        </div>
      </nav>
